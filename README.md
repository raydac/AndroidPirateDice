...
# How to install?
The Android application is compatible with Android 2.1+. Either build it self or [download my prebuilt APK file](https://github.com/raydac/AndroidPirateDice/releases/download/1.0.1/PirateDice.apk) and install to your device. 
# How to use?
